...
<body>
    <div class="container-fluid">
        ...
        <br>
        <h3>Tem certeza que deseja excluir a Tag?</h3>
    </div>
    <div class="container-fluid">
        <?php include_once 'lib/mensagem.php'; ?>
        <p><strong><?php echo $tag['id'] . ' - ' . $tag['name']; ?></strong></p>
        <br>
        <form method="post" action="principal.php?control=tag&action=excluirTag">
            <input type="hidden" name="id" value="<?php echo $tag['id']; ?>">
            <button type="submit" value="Sim" class="btn btn-danger float-left">Sim</button>
        </form>

        <a class="btn btn-primary float-left" style="margin-left: 30px" href="principal.php?action=tags">Não</a>
    </div>
</body>
</html>